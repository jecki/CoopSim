...
from PolymorphicStrategies import PolymorphicStrategy
...
NUM_ITERATIONS = PD.NUM_ITERATIONS # number of rounds in the reiterated PD
...
##                                   Dynamics.UniformDistribution(len(value)))
    ...
    def __init__(self, name, strategyList = [], population = None,
              ...
              iterations = NUM_ITERATIONS, samples = NUM_SAMPLES, payoff = (5.,3.,1.,0.),
